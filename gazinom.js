...
waitForElm('main.sb').then((elm)=>{
    ...
    <img width="260px" height="31px" class="center mbxs mtm" src="https://www.casinogranmadridonline.es/img/general/svg/general-icons.svg">
...
<p class="text">
    Biz, İspanya'da faaliyet izni alan ilk <strong><a href="https://www.casinogranmadridonline.es/" class="link--pink">çevrimiçi kumarhane</a></strong> olarak, müşterilerimize yasal, güvenli ve güvenilir bir şekilde eksiksiz bir çevrimiçi kumarhane deneyimi sunuyoruz.
</p>
...
<div class="cards">
    <img class="card-home" loading="lazy" width="396" height="150" alt="Kumarhane" src="https://www.casinogranmadridonline.es/img/card-1.webp">
    <img class="card-home" loading="lazy" width="396" height="150" alt="Çevrimiçi kumarhane" src="https://www.casinogranmadridonline.es/img/card-2-3000.webp">
    <img class="card-home" loading="lazy" width="396" height="150" alt="En iyi kumarhane" src="https://www.casinogranmadridonline.es/img/card-3.webp">
    <img class="card-home" loading="lazy" width="396" height="150" alt="Kumarhane oyna" src="https://www.casinogranmadridonline.es/img/card-4.webp">
</div>
