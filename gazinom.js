  ...
  <style>
                    ...
                    <li class="sectionContact-item">
                        <div class="sectionContact-wrapper">
                            ...
                            <p id="stateChat" class="sectionContact-text">
                                7/24 Kesinitsiz Canlı Destek
                            </p>
                            <button onclick="" id="sendmail" class="sectionContact-button" type="button"> Şimdi Canlı Sohbete Bağlan </button>
                        </div>
                    </li>
    ...
    function addseeall() {
       waitForElm('.category-item-3867  .slide-bars').then((elm)=>{
        ...
        const check = ()=> {
            if (document.getElementsByClassName("home-top-casino").length<10) {
